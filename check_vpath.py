...
def getStatus():
    ...
    while True:
        try:
            vpathname = snmp_get('1.3.6.1.4.1.3845.31.4.2.2.16.2.1.3.' + str(i), hostname=ip, community=community, version=2)
            state = snmp_get('1.3.6.1.4.1.3845.31.4.2.2.16.2.1.4.' + str(i), hostname=ip, community=community, version=2)
        except:
